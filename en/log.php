...
$is_logged_in = isLoggedIn(); // Assuming you have a function that checks if the user is logged in
...
if ($is_logged_in) {
    ...
    $country_id = getUserCountryId($buwana_conn, $buwana_id); // Ensure this function is available
