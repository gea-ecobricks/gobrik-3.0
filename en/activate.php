...
<div id="form-submission-box" class="landing-page-form">
    <div class="form-container">
        ...
        <div style="display:flex;flex-flow:row;justify-content:center;width:100%;">
            <div><a href="#" onclick="showModalInfo('terms')" class="underline-link" style="margin:auto;padding: 15px;">Our new Terms of Service</a>.</div>

            <div><a href="https://earthen.io/gobrik-regen" class="underline-link" target="_blank" style="margin:auto;padding: 15px;">The Great GoBrik Regeneration</a></div>
            <div><a href="https://github.com/gea-ecobricks/gobrik-3.0" class="underline-link" target="_blank" style="margin:auto;padding: 15px;">GoBrik 3.0 Code Repository</a></div>
       </div>
