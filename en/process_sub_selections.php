...
function getExistingMemberId($email) {
    try {
        $ghost_api_url = "https://earthen.io/ghost/apiadmin/members/?filter=email:" . urlencode($email);
        $jwt = createGhostJWT();
...
function subscribeUserToNewsletter($email, $newsletter_id) {
    try {
        $ghost_api_url = "https://earthen.io/ghost/apiadmin/members/";
        $jwt = createGhostJWT();
...
function updateSubscribeUser($member_id, $newsletter_id) {
    try {
        $ghost_api_url = "https://earthen.io/ghost/apiadmin/members/" . $member_id . '/';
        $jwt = createGhostJWT();
