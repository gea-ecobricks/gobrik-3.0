...
$languages = [];
$sql_languages = "SELECT lang_id, languages_name_en, language_name_id, language_name_fr, language_name_es, language_active FROM languages_tb ORDER BY languages_eng_name";
