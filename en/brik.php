...
<div id="main-content">
    ...
    <div class="side">
        <div class="side-module-desktop-mobile">
            ...
            <br>
            <h4 data-lang-id="104-side-authenticated-text">Authenticated!</h4>
