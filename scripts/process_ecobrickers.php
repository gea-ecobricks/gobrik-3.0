...
<div id="knack-response">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // Enable output buffering and flushing
        ...
        do {
            $url = "https://api.knack.com/v1/objects/$object_id/records?filters=" . urlencode(json_encode($filters)) . "&sort_field=field_261&sort_order=asc&rows_per_page=25";
