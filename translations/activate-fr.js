...
const fr_Page_Translations = {
    ...
    "0002-activate-explantion-2": "À la place, nous avons migré toutes nos données vers notre propre serveur indépendant et autonome. Notre nouveau GoBrik 3.0 est maintenant 100% open source et entièrement axé sur la responsabilité écologique. Nous avons également développé notre propre système de connexion Buwana comme alternative aux connexions Google et Apple. Pour nous rejoindre sur le GoBrik régénéré avec ",
    "0002-activate-explantion-3": " veuillez prendre une minute pour passer à un compte Buwana.",
   "0003-activate-button": '<input type="submit" id="submit-button" value="🍃 Mettre à niveau le compte !" class="submit-button activate">',
    ...
    "0005-new-terms": "Nouveaux termes et conditions de Buwana & GoBrik",
    "0005-regen-blog": "Pourquoi ? Lisez notre article de blog 'La Grande Régénération de GoBrik'.",
    ...
    "014-i-agree-newsletter": "Veuillez m'envoyer la <a href=\"#\" onclick=\"showModalInfo('earthen', 'fr')\" class=\"underline-link\">newsletter Earthen</a> pour les mises à jour sur les applications, les écobriques et les projets en terre",
        "015-confirm-pass-button": '<input type="submit" id="submit-button" value="Confirmer Mot de Passe" class="submit-button disabled">',
