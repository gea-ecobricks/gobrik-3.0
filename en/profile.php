...
$(function () {
    ...
    $("#location_full").autocomplete({
        ...
        minLength: 1 // Adjusted to allow faster location suggestions
    });
    ...
    function fetchNearbyRivers(lat, lon) {
        ...
        $.get(overpassUrl, function (data) {
            ...
            // Add the additional fixed options using translation variables if available
            ...
            $("#watershed_select").append(
                $('<option>', {
                    ...
                    text: translations['011d-unseen'], // "I don't see my local river/stream"
